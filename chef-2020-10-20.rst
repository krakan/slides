...
* `chefdk` är ett liknande paket byggt av communityn (deprecated)
...
* Gör steg 1-3 i `Try Chef Infra <try-chef/TryChefInfra.html>`_ (https://jonaseel.se/slides/try-chef/TryChefInfra.html)
